...
class _AllRequestsScreenState extends State<AllRequestsScreen> {
  ...
  Future<void> fetchAllRequests() async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/requests/viewrequests'), // Assuming this endpoint returns all requests
        headers: {
  ...
  void handleRequestUpdate() {
    fetchAllRequests(); // Refresh local list
                      ...
                      children: [
                        ...
                        _buildNavItem(Icons.description, "Requests", onTap: () {
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AllRequestsScreen(token: widget.token, refreshDashboard: widget.refreshDashboard),
                            ),
                          );
                        }),
